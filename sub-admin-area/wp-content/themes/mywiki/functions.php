...
function mywiki_search_form($html) {   
    $html= '<form class="asholder search-main col-md-12 col-sm-12 col-xs-12" role="search" method="get" id="searchformtop" action="'.esc_url(home_url()).'">        
          <div class="input-group" id="suggest">
            <input name="s" id="s" type="text" onKeyUp="suggest(this.value);" onBlur="fill();" class="search-query form-control pull-right" autocomplete="off" placeholder="'.esc_attr__('What are you looking for ? Search, Try it !','mywiki').'" data-provide="typeahead" data-items="4" data-source="">
